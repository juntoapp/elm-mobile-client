...
var _user$project$Models$initialModel = function (route) {
	return {route: route, routeLoaded: _elm_lang$core$Maybe$Nothing};
};
var _user$project$Models$Model = F2(
	function (a, b) {
		return {route: a, routeLoaded: b};
	});
var _user$project$Models$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Models$LoadRoute = {ctor: 'LoadRoute'};
var _user$project$Models$DashboardDateRoute = function (a) {
	return {ctor: 'DashboardDateRoute', _0: a};
};
var _user$project$Models$DashboardRoute = {ctor: 'DashboardRoute'};
var _user$project$Models$StartRoute = {ctor: 'StartRoute'};

var _user$project$Dashboard_Calendar$listLastElem = function (list) {
	listLastElem:
	while (true) {
		var _p0 = list;
		if (_p0.ctor === '[]') {
			...
			if (_p0._1.ctor === '[]') {
				...
				var _v1 = _p0._1;
				list = _v1;
				continue listLastElem;
			}
		}
	}
};
var _user$project$Dashboard_Calendar$weekDayToNum = function (d) {
	var _p1 = _elm_lang$core$Date$dayOfWeek(d);
	switch (_p1.ctor) {
		case 'Mon':
			return 0;
		case 'Tue':
...
var _user$project$Dashboard_Calendar$genRow = function (row) {
	genRow:
	while (true) {
		if (_elm_lang$core$Native_Utils.eq(
			...
			var tailDate = function () {
				var _p2 = _user$project$Dashboard_Calendar$listLastElem(row);
				if (_p2.ctor === 'Just') {
					var _p3 = _p2._0;
					return (_elm_lang$core$Native_Utils.cmp(
						_user$project$Dashboard_Calendar$weekDayToNum(_p3),
						6) < 0) ? {
						ctor: '::',
						_0: A3(_justinmimbs$elm_date_extra$Date_Extra$add, _justinmimbs$elm_date_extra$Date_Extra$Day, 1, _p3),
						_1: {ctor: '[]'}
					} : {ctor: '[]'};
				} else {
					return {ctor: '[]'};
			...
			var headDate = function () {
				var _p4 = _elm_lang$core$List$head(row);
				if (_p4.ctor === 'Just') {
					var _p5 = _p4._0;
					return (_elm_lang$core$Native_Utils.cmp(
						_user$project$Dashboard_Calendar$weekDayToNum(_p5),
						0) > 0) ? {
						ctor: '::',
						_0: A3(_justinmimbs$elm_date_extra$Date_Extra$add, _justinmimbs$elm_date_extra$Date_Extra$Day, -1, _p5),
						_1: {ctor: '[]'}
					} : {ctor: '[]'};
				} else {
					return {ctor: '[]'};
			...
			var _v5 = _elm_lang$core$List$concat(
				{
					ctor: '::',
					_0: headDate,
					_1: {
...
var _user$project$Dashboard_Calendar$dateToString = function (x) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		'',
		A2(
			...
			A2(
				...
				A2(
					...
					A3(
						...
						_elm_lang$core$Native_Utils.chr('0'),
						_elm_lang$core$Basics$toString(
							_justinmimbs$elm_date_extra$Date_Extra$monthNumber(x))),
					A2(
						_elm_lang$core$Basics_ops['++'],
						'-',
						A3(
...
var _user$project$Dashboard_Calendar$timeStampToInteger = function (x) {
	return A2(
...
var _user$project$Dashboard_Calendar$compareDates = F2(
	function (x, y) {
		return A2(
			_elm_lang$core$Basics$compare,
			_user$project$Dashboard_Calendar$timeStampToInteger(x),
			_user$project$Dashboard_Calendar$timeStampToInteger(y));
	});
var _user$project$Dashboard_Calendar$daySelectionPath = function (datemaybe) {
	var _p6 = datemaybe;
	if (_p6.ctor === 'Just') {
		return A2(
			_elm_lang$core$Basics_ops['++'],
			'#dashboard/',
			_user$project$Dashboard_Calendar$dateToString(_p6._0));
	} else {
		return '#dashboard/';
	}
};
var _user$project$Dashboard_Calendar$dayToHtml = F3(
	function (selectedDay, today, day) {
		var selected = _elm_lang$core$Native_Utils.eq(selectedDay, day) ? 'calendar__weekday--selected ' : '';
		var time = function () {
			var _p7 = A2(_user$project$Dashboard_Calendar$compareDates, day, today);
			switch (_p7.ctor) {
				case 'EQ':
					return 'calendar__weekday--today ';
				case 'LT':
					return 'calendar__weekday--past ';
				default:
					return '';
			}
		}();
		var classes = A2(_elm_lang$core$Basics_ops['++'], time, selected);
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class(
					A2(_elm_lang$core$Basics_ops['++'], 'calendar__weekday ', classes)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$a,
					{
						...
						_0: _elm_lang$html$Html_Attributes$href(
							_user$project$Dashboard_Calendar$daySelectionPath(
								_elm_lang$core$Maybe$Just(day))),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
...
var _user$project$Dashboard_Calendar$generateDays = F2(
	function (selectedDay, today) {
		var thirdRow = _user$project$Dashboard_Calendar$genRow(
			{
				ctor: '::',
				_0: A3(_justinmimbs$elm_date_extra$Date_Extra$add, _justinmimbs$elm_date_extra$Date_Extra$Week, 1, selectedDay),
				_1: {ctor: '[]'}
			});
		var secondRow = _user$project$Dashboard_Calendar$genRow(
			{
				ctor: '::',
				_0: selectedDay,
				_1: {ctor: '[]'}
			});
		var firstRow = _user$project$Dashboard_Calendar$genRow(
			{
				ctor: '::',
				_0: A3(_justinmimbs$elm_date_extra$Date_Extra$add, _justinmimbs$elm_date_extra$Date_Extra$Week, -1, selectedDay),
				_1: {ctor: '[]'}
		...
		return {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('calendar__weekdays'),
					_1: {ctor: '[]'}
				},
				A2(
					_elm_lang$core$List$map,
					A2(_user$project$Dashboard_Calendar$dayToHtml, selectedDay, today),
					firstRow)),
			_1: {
				ctor: '::',
				_0: A2(
...
var _user$project$Dashboard_Calendar$view = F2(
	function (model, paramSelectedDay) {
		var _p9 = model.routeLoaded;
		if (_p9.ctor === 'Just') {
			var _p11 = _p9._0;
			var _p10 = paramSelectedDay;
			if (_p10.ctor === 'Ok') {
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					A2(
						_elm_lang$core$Basics_ops['++'],
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$class('calendar__weekdays calendar__weekdays--title'),
									_1: {ctor: '[]'}
								},
								A2(
									_elm_lang$core$List$map,
									function (x) {
										return A2(
											...
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$class('calendar__weekday calendar__weekday--title'),
												_1: {ctor: '[]'}
											},
											{
												ctor: '::',
						...
						A2(_user$project$Dashboard_Calendar$generateDays, _p10._0, _p11)));
			} else {
				return A2(
					_elm_lang$html$Html$div,
					{ctor: '[]'},
					A2(
						...
						A2(_user$project$Dashboard_Calendar$generateDays, _p11, _p11)));
			}
		} else {
			return A2(
				_elm_lang$html$Html$div,
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('failed to generate calendar'),
					_1: {ctor: '[]'}
				});
		}
	});

var _user$project$Dashboard_DayTitleBar$removeTimeFromDate = function (x) {
	return A7(
...
var _user$project$Dashboard_DayTitleBar$formateDate = function (date) {
	return A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(
			_elm_lang$core$Date$dayOfWeek(date)),
...
var _user$project$Dashboard_DayTitleBar$labels = {today: 'today', yesterday: 'yesterday', tomorrow: 'tomorrow', dbyesterday: 'day before yesterday', datomorrow: 'day after tomorrow', blank: '', fail: 'unable to get current timestamp'};
var _user$project$Dashboard_DayTitleBar$processRelation = F2(
	function (ptoday, pselectedDay) {
		var selectedDay = _user$project$Dashboard_DayTitleBar$removeTimeFromDate(pselectedDay);
		var today = _user$project$Dashboard_DayTitleBar$removeTimeFromDate(ptoday);
		if (_elm_lang$core$Native_Utils.eq(
			A2(_justinmimbs$elm_date_extra$Date_Extra$compare, selectedDay, today),
			_elm_lang$core$Basics$EQ)) {
			return _user$project$Dashboard_DayTitleBar$labels.today;
		} else {
			if (_elm_lang$core$Native_Utils.eq(
				A2(_justinmimbs$elm_date_extra$Date_Extra$compare, selectedDay, today),
				_elm_lang$core$Basics$LT)) {
				var _p0 = A3(_justinmimbs$elm_date_extra$Date_Extra$diff, _justinmimbs$elm_date_extra$Date_Extra$Day, selectedDay, today);
				switch (_p0) {
					case 1:
						return _user$project$Dashboard_DayTitleBar$labels.yesterday;
					case 2:
						return _user$project$Dashboard_DayTitleBar$labels.dbyesterday;
					default:
						return _user$project$Dashboard_DayTitleBar$labels.blank;
				}
			} else {
				var _p1 = A3(_justinmimbs$elm_date_extra$Date_Extra$diff, _justinmimbs$elm_date_extra$Date_Extra$Day, selectedDay, today);
				switch (_p1) {
					case -1:
						return _user$project$Dashboard_DayTitleBar$labels.tomorrow;
					case -2:
						return _user$project$Dashboard_DayTitleBar$labels.datomorrow;
					default:
						return _user$project$Dashboard_DayTitleBar$labels.blank;
				}
			}
...
var _user$project$Dashboard_DayTitleBar$printBar = F2(
	function (relation, formatedDate) {
		return _elm_lang$core$Native_Utils.eq(relation, _user$project$Dashboard_DayTitleBar$labels.blank) ? A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$class('calendar__dayTitleBar'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('calendar__selectedDay'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text(formatedDate),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}) : A2(
				...
				_1: {
					...
					_1: {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(relation),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _user$project$Dashboard_DayTitleBar$view = F2(
	function (model, paramSelectedDay) {
		var _p2 = model.routeLoaded;
		if (_p2.ctor === 'Nothing') {
			return A2(_user$project$Dashboard_DayTitleBar$printBar, _user$project$Dashboard_DayTitleBar$labels.blank, _user$project$Dashboard_DayTitleBar$labels.fail);
		} else {
			var _p5 = _p2._0;
			var _p3 = paramSelectedDay;
			if (_p3.ctor === 'Err') {
				var formatedDate = _user$project$Dashboard_DayTitleBar$formateDate(_p5);
				return A2(_user$project$Dashboard_DayTitleBar$printBar, _user$project$Dashboard_DayTitleBar$labels.today, formatedDate);
			} else {
				var _p4 = _p3._0;
				var relationToToday = A2(_user$project$Dashboard_DayTitleBar$processRelation, _p5, _p4);
				var formatedDate = _user$project$Dashboard_DayTitleBar$formateDate(_p4);
				return A2(_user$project$Dashboard_DayTitleBar$printBar, relationToToday, formatedDate);
			}
		}
	});

var _user$project$Dashboard_View$topHeadBar = A2(
	_elm_lang$html$Html$div,
	{
		ctor: '::',
		_0: _elm_lang$html$Html_Attributes$class('topHeadBar'),
		_1: {ctor: '[]'}
	},
	{
		ctor: '::',
		_0: A2(
			_elm_lang$html$Html$a,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href(
					_user$project$Dashboard_Calendar$daySelectionPath(_elm_lang$core$Maybe$Nothing)),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Dashboard_View$view = F2(
	function (model, selectedDate) {
		return A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('dashboard__header'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _user$project$Dashboard_View$topHeadBar,
						_1: {
							ctor: '::',
							_0: A2(
								_user$project$Dashboard_Calendar$view,
								model,
								_elm_lang$core$Date$fromString(selectedDate)),
							_1: {
								ctor: '::',
								_0: A2(
									_user$project$Dashboard_DayTitleBar$view,
									model,
									_elm_lang$core$Date$fromString(selectedDate)),
								_1: {ctor: '[]'}
							}
...
var _user$project$Routing$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Models$DashboardRoute, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Models$DashboardDateRoute,
				A2(
			...
			_1: {
				...
				_0: A2(
					_evancz$url_parser$UrlParser$map,
					_user$project$Models$LoadRoute,
					_evancz$url_parser$UrlParser$s('load')),
				_1: {ctor: '[]'}
			}
		}
	});
...
var _user$project$View$notFoundView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
...
var _user$project$View$page = function (model) {
	...
	switch (_p0.ctor) {
		case 'DashboardRoute':
			return A2(_user$project$Dashboard_View$view, model, '');
		case 'DashboardDateRoute':
			return A2(_user$project$Dashboard_View$view, model, _p0._0);
		default:
			return _user$project$View$notFoundView(model);
	}
};
			...
			case 'OnLocationChange':
				...
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{route: newRoute}),
					_1: A2(_elm_lang$core$Task$perform, _user$project$Msgs$SetDate, _elm_lang$core$Date$now)
				};
			case 'SetDate':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							routeLoaded: _elm_lang$core$Maybe$Just(_p0._0)
						}),
